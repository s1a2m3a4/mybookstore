...
//       <footer className="footer footer-center bg-base-100 text-base-content rounded p-10 dark:bg-slate-900 dark:text-white">
...
const Footer = () => {
  return (
    <footer className="w-full bg-slate-700 text-white p-4 md:p-6 mt-auto">
